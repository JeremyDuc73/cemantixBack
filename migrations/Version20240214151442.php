 ...
 */
final class Version20240214151442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE embedding (id INT NOT NULL, word_id INT NOT NULL, value DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_485B55AEE357438D ON embedding (word_id)');
        $this->addSql('CREATE TABLE word (id INT NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
